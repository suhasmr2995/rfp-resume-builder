...
const Header = () => {
    return <div className="h-full flex flex-col flex-1 mx-auto justify-center bg-blue-600">
        <header className="sticky bg-background w-full py-2 top-0 justify-between inline-flex z-10 drop-shadow-md">
            <div className="justify-between items-center flex w-full mx-auto px-6">
                ...
                <div className="app-header-icons flex flex-row gap-3 h-3 items-center justify-center">
                    <h2 className="text-4xl font-bold text-center bg-clip-text text-white">
                        Gen AI Tool{/* Placeholder text */}
                    </h2>
                </div>
